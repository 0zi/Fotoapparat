...
public class UpdateOrientationRoutine implements OrientationSensor.Listener {
  ...
  public UpdateOrientationRoutine(CameraDevice cameraDevice, OrientationSensor orientationSensor,
  ...
  @Override public void onOrientationChanged(final int degrees) {
