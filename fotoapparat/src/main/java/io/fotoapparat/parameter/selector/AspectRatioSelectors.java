...
public class AspectRatioSelectors {
  ...
  public static SelectorFunction<Size> aspectRatio(float aspectRatio,
    ...
    return Selectors.filtered(selector, new AspectRatioPredicate(aspectRatio));
  }
  ...
  private static class AspectRatioPredicate implements Predicate<Size> {
    ...
    @Override public boolean condition(@Nullable Size value) {
      return value != null && Math.abs(aspectRatio - value.getAspectRatio()) < ASPECT_RATIO_EPSILON;
    }
  }
}
