...
public class RendererParameters {
  ...
  public RendererParameters(Size previewSize, int frameRotation) {
  ...
  @Override public boolean equals(Object o) {
    ...
    return frameRotation == that.frameRotation && (previewSize != null ? previewSize.equals(
        that.previewSize) : that.previewSize == null);
  }
