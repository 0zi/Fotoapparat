...
public class PhotoResult {
  ...
  public static PhotoResult fromFuture(Future<Photo> photoFuture) {
    return new PhotoResult(PendingResult.fromFuture(photoFuture));
  }
  ...
  public PendingResult<BitmapPhoto> toBitmap(Transformer<Size, Size> sizeTransformer) {
    return pendingResult.transform(new BitmapPhotoTransformer(sizeTransformer));
  }
  ...
  public PendingResult<Void> saveToFile(File file) {
    return pendingResult.transform(SaveToFileTransformer.create(file));
  }
