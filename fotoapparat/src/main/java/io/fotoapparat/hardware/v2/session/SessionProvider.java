 ...
 */
@SuppressWarnings("NewApi") public class SessionProvider implements TextureManager.Listener {
  ...
  public SessionProvider(StillSurfaceReader surfaceReader, CameraConnection connection,
      CaptureRequestFactory captureRequestFactory, TextureManager textureManager,
  ...
  @Override public void onSurfaceAvailable(Surface surface) {
    ...
    try {
      ...
      previewSession = new PreviewSession(camera, previewRequest, surfaces, cameraThread);
