 ...
 */
@RequiresApi(api = Build.VERSION_CODES.LOLLIPOP) public class CaptureResultTransformer
    implements Transformer<CaptureResult, CaptureResultState> {

  @Override public CaptureResultState transform(CaptureResult input) {
