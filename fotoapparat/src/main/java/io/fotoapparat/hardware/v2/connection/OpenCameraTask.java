 ...
 */
@RequiresApi(api = Build.VERSION_CODES.LOLLIPOP) @SuppressWarnings("MissingPermission")
class OpenCameraTask extends CameraDevice.StateCallback {
  ...
  @NonNull public CameraDevice execute(String cameraId) {
    try {
      manager.openCamera(cameraId, this, cameraThread.createHandler());
