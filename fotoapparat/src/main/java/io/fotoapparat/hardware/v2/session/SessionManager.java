 ...
 */
@SuppressWarnings("NewApi") public class SessionManager
    implements PreviewOperator, CameraConnection.Listener {

  private final SessionProvider sessionProvider;
  private PreviewSession session;

  public SessionManager(CameraConnection connection, SessionProvider sessionProvider) {
