 ...
 */
@RequiresApi(api = Build.VERSION_CODES.LOLLIPOP) public class TextureManager
  ...
  @Override public void onDisplayOrientationChanged(int orientation) {
  ...
  @Override public void setDisplaySurface(Object displaySurface) {
    ...
    surface =
        new SetupTextureViewRoutine(textureView, parametersProvider, screenOrientation).call();
