 ...
 */
@RequiresApi(api = Build.VERSION_CODES.LOLLIPOP) public class FocusResultTransformer
    implements Transformer<CaptureResult, FocusResult> {

  @Override public FocusResult transform(CaptureResult input) {
