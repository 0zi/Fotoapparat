 ...
 */
@RequiresApi(api = Build.VERSION_CODES.LOLLIPOP) public class ExposureResultTransformer
    implements Transformer<CaptureResult, ExposureResultState> {

  @Override public ExposureResultState transform(CaptureResult input) {
