 ...
 */
@RequiresApi(api = Build.VERSION_CODES.LOLLIPOP) public class OrientationManager
   ...
   */
  @Override public void setDisplayOrientation(int orientation) {
  ...
  public int getPhotoOrientation() {
    ...
    return OrientationUtils.computeImageOrientation(orientation,
        characteristics.getSensorOrientation(), characteristics.isFrontFacingLens());
  }
