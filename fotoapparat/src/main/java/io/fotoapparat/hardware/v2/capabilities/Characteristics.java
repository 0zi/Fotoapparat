 ...
 */
@SuppressWarnings("ConstantConditions") @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
public class Characteristics {
  ...
  @NonNull private static Set<Size> convertSizes(android.util.Size[] availableSizes) {
