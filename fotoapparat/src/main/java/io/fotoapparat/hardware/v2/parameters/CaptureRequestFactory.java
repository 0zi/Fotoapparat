 ...
 */
@RequiresApi(api = Build.VERSION_CODES.LOLLIPOP) public class CaptureRequestFactory {
  ...
  public CaptureRequestFactory(CameraConnection cameraConnection, StillSurfaceReader surfaceReader,
      TextureManager textureManager, ParametersProvider parametersProvider) {
  ...
  public CaptureRequest createPreviewRequest() throws CameraAccessException {
    ...
    return CaptureRequestBuilder.create(camera, CameraDevice.TEMPLATE_PREVIEW)
        .into(viewSurface)
        .flash(flash)
        .build();
  }
  ...
  public CaptureRequest createLockRequest() throws CameraAccessException {
    ...
    return CaptureRequestBuilder.create(camera, CameraDevice.TEMPLATE_STILL_CAPTURE)
        .into(surface)
        .flash(flash)
