 ...
 */
@RequiresApi(api = Build.VERSION_CODES.LOLLIPOP) public class LensOperation<T>
   ...
   */
  public static <T> LensOperation<T> from(CaptureRequest request, Handler handler,
      Transformer<CaptureResult, T> transformer, CameraCaptureSession captureSession) {

    WrappedCaptureCallback<T> wrappedCaptureCallback =
        WrappedCaptureCallback.newInstance(captureSession, request, handler, transformer);
