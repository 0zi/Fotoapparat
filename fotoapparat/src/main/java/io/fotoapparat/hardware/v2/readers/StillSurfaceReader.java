 ...
 */
@RequiresApi(api = Build.VERSION_CODES.LOLLIPOP) public class StillSurfaceReader {
  ...
  private void createImageReader() {
    ...
    imageReader =
        ImageReader.newInstance(largestSize.width, largestSize.height, ImageFormat.JPEG, 1);
  }
