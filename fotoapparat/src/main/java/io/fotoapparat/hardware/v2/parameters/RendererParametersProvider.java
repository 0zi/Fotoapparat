 ...
 */
@SuppressWarnings("NewApi") public class RendererParametersProvider
    implements RendererParametersOperator {
  ...
  @Override public RendererParameters getRendererParameters() {
    return new RendererParameters(parametersProvider.getPreviewSize(),
