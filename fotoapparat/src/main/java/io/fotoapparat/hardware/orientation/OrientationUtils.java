...
public class OrientationUtils {
   ...
   */
  public static int computeDisplayOrientation(int screenRotationDegrees, int cameraRotationDegrees,
   ...
   */
  public static int computeImageOrientation(int screenRotationDegrees, int cameraRotationDegrees,
      boolean cameraIsMirrored) {
    int rotation;
